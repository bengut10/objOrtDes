...
public class Controller {
	...
	public Controller(MemberList memberList, Collection collection) {
	...
	public Calendar checkout(int memberID, int resourceID) {
		...
		Calendar newDueDate = resource.calculateNewDueDate(startDate, member);
        resource.setDueDate(newDueDate);
